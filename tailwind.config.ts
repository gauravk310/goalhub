  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        goal: {
          daily: "hsl(var(--goal-daily))",
          "daily-bg": "hsl(var(--goal-daily-bg))",
          weekly: "hsl(var(--goal-weekly))",
          "weekly-bg": "hsl(var(--goal-weekly-bg))",
          monthly: "hsl(var(--goal-monthly))",
          "monthly-bg": "hsl(var(--goal-monthly-bg))",
        },
        chart: {
          "1": "hsl(var(--chart-1))",
          "2": "hsl(var(--chart-2))",
